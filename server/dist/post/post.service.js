...
let PostService = class PostService {
    ...
    async getPostById(id, user) {
        try {
            ...
            console.log(error);
            throw new common_1.InternalServerErrorException('장소를 가져오는 도중 에러가 발생했습니다.');
        }
    }
    ...
    async deletePost(id, user) {
        try {
            ...
            console.log(error);
            throw new common_1.InternalServerErrorException('장소를 삭제하는 도중 에러가 발생했습니다.');
        }
    }
    async updatePost(id, updatePostDto, user) {
        ...
        try {
            ...
            console.log(error);
            throw new common_1.InternalServerErrorException('장소를 수정하는 도중 에러가 발생했습니다.');
        }
        return post;
    }
